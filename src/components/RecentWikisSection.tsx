...
interface RecentWikisSectionProps {
  onSelectWiki: (wikiId: string) => void;
  onAddWiki: () => void;
  activeWikiId?: string;
}

export const RecentWikisSection: React.FC<RecentWikisSectionProps> = ({
  onSelectWiki,
  onAddWiki,
}) => {
  return (
    <section className="mb-7">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-2.5">
        ...
        <div
          ...
          className="group bg-[#151517] rounded-lg border border-[#232326] hover:border-[#35353a] overflow-hidden transition-colors cursor-pointer flex flex-col"
        >
          ...
          <div className="relative aspect-[4/3] w-full bg-[#0B0B0D] overflow-hidden">
            ...
            />
            {/* IMDb Rating Chip */}
            <div className="absolute top-1.5 left-1.5 bg-[#0B0B0D]/95 border border-[#232326] px-1.5 py-0.5 rounded text-[10px] font-bold text-[#F5F5F5] flex items-center gap-0.5 select-none">
        ...
        <button
          onClick={onAddWiki}
          className="group bg-[#151517] rounded-lg border border-dashed border-[#232326] hover:border-[#35353a] hover:bg-[#1a1a1c] p-4 flex flex-col items-center justify-center text-[#8A8A8E] hover:text-[#F5F5F5] transition-colors cursor-pointer aspect-[4/3] sm:aspect-auto"
