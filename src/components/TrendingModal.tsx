...
import { TrendingItem } from '../data/fandomData';

interface TrendingModalProps {
  item: TrendingItem | null;
  onClose: () => void;
  onExploreWiki?: (wikiName: string) => void;
}

export const TrendingModal: React.FC<TrendingModalProps> = ({ item, onClose, onExploreWiki }) => {
  if (!item) return null;
