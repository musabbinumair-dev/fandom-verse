const FANDOM_TOOLS = [
  ...
  },
  {
    ...
    description: "Preloaded with anime power scalers, Pok\xE9mon competitive tiers, Elden Ring weapon rankings, and movie franchises."
  },
  {
    id: "vtmb2-planner",
...
const UtilitiesView = ({
  ...
  />
    ...
    /* Badge top right like PLAN YOUR BUILD */
              ...
              {tool.badge && <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-xs text-slate-900 text-[10px] font-extrabold uppercase px-2 py-0.5 rounded shadow-sm">
                  {tool.badge}
                </div>}
