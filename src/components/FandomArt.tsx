...
// Authentic Pokéball Icon matching the screenshot
export const PokeballIcon: React.FC<{ size?: number; className?: string }> = ({ size = 48, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 100 100"
...
// Fandom Flame / Heart Icon
export const FandomFlameIcon: React.FC<{ size?: number; className?: string }> = ({ size = 28, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 120 120"
...
// Fandomverse Brand Logo (Flame + Wordmark)
export const FandomBrand: React.FC<{ light?: boolean; size?: 'sm' | 'md' | 'lg' }> = ({ size = 'md' }) => {
  const isSm = size === 'sm';
  const isLg = size === 'lg';

  return (
    <div className="flex items-center gap-1.5 select-none tracking-tight">
      <svg
...
export const EldenRingArt: React.FC<{ className?: string }> = ({ className = '' }) => (
...
// Star Wars Wookieepedia Art
export const StarWarsArt: React.FC<{ className?: string }> = ({ className = '' }) => (
...
export const SilentHillArt: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative w-full h-full bg-[#0a0505] overflow-hidden ${className}`}>
    <svg className="absolute inset-0 w-full h-full object-cover" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      <defs>
...
// Strange New Worlds Christina Chong Art
export const StrangeNewWorldsArt: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative w-full h-full bg-slate-950 overflow-hidden ${className}`}>
    <svg className="absolute inset-0 w-full h-full object-cover" viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice">
      <defs>
...
// Jigglypuff Discussion Thumbnail (Matches screenshot hand-drawn look)
export const JigglypuffThumb: React.FC<{ size?: number; className?: string }> = ({ size = 64, className = '' }) => (
  <div className={`relative flex items-center justify-center bg-pink-50 rounded-lg border border-pink-200 overflow-hidden ${className}`} style={{ width: size, height: size }}>
...
// Anime Mafuyu Sketch Thumbnail (Matches screenshot)
export const AnimeMafuyuThumb: React.FC<{ size?: number; className?: string }> = ({ size = 64, className = '' }) => (
  <div className={`relative flex items-center justify-center bg-slate-100 rounded-lg border border-slate-300 overflow-hidden ${className}`} style={{ width: size, height: size }}>
    <svg viewBox="0 0 100 100" className="w-full h-full p-1">
...
// Powerpuff Pokemon Thumbnail (Matches screenshot)
export const PowerpuffThumb: React.FC<{ size?: number; className?: string }> = ({ size = 64, className = '' }) => (
  <div className={`relative flex items-center justify-center bg-pink-100 rounded-lg border border-pink-300 overflow-hidden ${className}`} style={{ width: size, height: size }}>
...
// Trending 1: Mephisto (Hungry Shark Evolution)
export const MephistoArt: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative w-full h-full bg-indigo-950 overflow-hidden ${className}`}>
...
// Trending 2: Toyman (Absolute Universe)
export const ToymanArt: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative w-full h-full bg-slate-900 overflow-hidden ${className}`}>
    <svg className="absolute inset-0 w-full h-full object-cover" viewBox="0 0 200 150" preserveAspectRatio="xMidYMid slice">
...
// Trending 3: Ace Trappola
export const AceTrappolaArt: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative w-full h-full bg-rose-950 overflow-hidden ${className}`}>
    <svg className="absolute inset-0 w-full h-full object-cover" viewBox="0 0 200 150" preserveAspectRatio="xMidYMid slice">
      <defs>
...
// Trending 4: Numberland Art (Rainbow wonders block)
export const NumberlandArt: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`relative w-full h-full bg-cyan-900 overflow-hidden ${className}`}>
    <svg className="absolute inset-0 w-full h-full object-cover" viewBox="0 0 200 150" preserveAspectRatio="xMidYMid slice">
      <defs>
