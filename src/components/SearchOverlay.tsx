...
export const SearchOverlay: React.FC<SearchOverlayProps> = ({
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-slate-200 z-40 max-h-[75vh] overflow-y-auto p-4 animate-in fade-in duration-100">
