const Footer = ({ onOpenInfo }) => {
  return (
    <footer className="w-full bg-white border-t border-gray-200 mt-16 py-12 px-4 sm:px-6 select-none shadow-theme-card">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Logo (left) */}
        <div className="flex items-center gap-2">
          <span className="font-titan text-lg tracking-tight text-gray-900">
            FANDOM<span className="text-[#F59E0B]">VERSE</span>
          </span>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <a
            ...
            aria-label="Discord"
            className="w-9 h-9 rounded-full bg-gray-100 border border-gray-200 hover:border-[#F59E0B] text-gray-500 hover:text-[#F59E0B] flex items-center justify-center transition-all hover:scale-105"
          >
      ...
      {/* Copyright */}
      <div className="max-w-7xl mx-auto mt-8 pt-6 border-t border-gray-200 text-center sm:text-left text-xs text-gray-500 font-medium">
