...
export const Hero: React.FC<HeroProps> = ({ onOpenArticle }) => {
  return (
    <section className="relative w-full overflow-hidden border-b-2 border-[#231C14] bg-[#0A0A0C] select-none group">
