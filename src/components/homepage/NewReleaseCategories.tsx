...
export interface NewReleaseItem extends ContentItem {
  subTitle?: string;
  synopsis?: string;
}
...
// All 8 Popular Fandom Categories with Dedicated Topic Imagery
export const POPULAR_FANDOMS: NewReleaseItem[] = [
  {
    id: 'category-anime',
    title: 'Anime',
...
// Recent Updates Ranked items 01 to 10 (Exact structure from reference image)
export const RECENT_UPDATES_LIST: TrendingRankItem[] = [
  {
    rank: '01',
...
interface NewReleaseCategoriesProps {
  onSelectItem: (item: ContentItem) => void;
  onSeeMore?: () => void;
}

export const NewReleaseCategories: React.FC<NewReleaseCategoriesProps> = ({
  onSelectItem,
  onSeeMore,
}) => {
  const handleSeeMore = () => {
